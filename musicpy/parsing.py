"""
Parsing helper functions extracted from structures.py.

These functions handle note reading, settings processing, and tempo normalization.
They are imported back into structures.py to maintain backward compatibility.
"""

from copy import deepcopy as copy

if __name__ == 'musicpy.parsing':
