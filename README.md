...
## 你们有想过用代码来写音乐吗？ musicpy是一个可以让你用编程写音乐的python邻域特定语言，可以让你用非常简洁并且可读性高的语法通过乐理知识写出优美的音乐。musicpy除了用来创作音乐之外，还可以从乐理层面上来创作音乐和分析音乐，并且您可以在musicpy的基础上设计乐理算法来探索音乐的可能性。musicpy容易学，容易写，可读性也比较强，并且是一个完全计算机化的乐理系统。
